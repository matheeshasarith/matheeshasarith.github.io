...
const Hero = () => {
  return (
    <section
      ...
      style={{
        backgroundImage: "url(/images/general/donate.jpg)",
          ...
          <div className="w-full px-4">
            ...
            >
              <h1 className="mb-6 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2]">
                we are Sanjeew Sankruthika Pdanama Please join with us for island wide donation campaign.
              </h1>
              <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                There are many people who are in need of help. children, elders, and many more.  they were unable to find their daily needs. Please join with us to help them. Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi suscipit rem dignissimos quo odio ratione sed sixdzfsdfsdfsfsmilique vero et atque jghvjghvhgh. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Illum ex eveniet suscipit porro quia quos, quidem veniam beatae, voluptate in similique soluta obcaecati ipsam quae. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Provident null
              </p>
